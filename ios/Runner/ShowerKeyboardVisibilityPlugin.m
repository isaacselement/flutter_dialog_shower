...
#import "ShowerKeyboardVisibilityPlugin.h"

@import CoreLocation;

@interface ShowerKeyboardVisibilityPlugin() <FlutterStreamHandler>
...
@implementation ShowerKeyboardVisibilityPlugin

+(void) registerWithRegistrar:(NSObject<FlutterPluginRegistrar> *)registrar {
    FlutterEventChannel *stream = [FlutterEventChannel eventChannelWithName:@"shower_keyboard_visibility" binaryMessenger:[registrar messenger]];

    ShowerKeyboardVisibilityPlugin *instance = [[ShowerKeyboardVisibilityPlugin alloc] init];
