package com.xpel.shower.flutter_dialog_shower;
...
public class ShowerKeyboardVisibilityPlugin implements FlutterPlugin, ActivityAware, EventChannel.StreamHandler, ViewTreeObserver.OnGlobalLayoutListener {
  ...
  private void init(BinaryMessenger messenger) {
    final EventChannel eventChannel = new EventChannel(messenger, "shower_keyboard_visibility");
